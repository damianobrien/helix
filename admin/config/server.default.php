...
$config["postgres_port"] = 5432;
 ...
 //Enable debug logging in DB
 $config["enable_helix_log_db"] = false;

 //Exclude logging all requests in log file
 $config["log_exclude_request"] = false;
//-----------------------------------------------------------------------------
