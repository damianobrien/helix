...
class Database extends Object {
	...
	public static function getInstance($type=null, $host=null, $username=null, $password=null, $database=null, $port=null) {
        ...
        $dbname = alt($database, $config["postgres_database"]);
        //if connection to the same server type/dbname, use active instance
        //temporarily disabled this because postgres result was getting overwritten while
        //accessing db during result set loop
		if (false && isset(self::$instances[$type]) && ($dbname==$config["postgres_database"])) {
